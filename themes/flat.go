        ...
        <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="email-masthead">
              <a class="email-masthead_name" href="{{.Pigeon.Product.Link}}" target="_blank">
                {{ if .Pigeon.Product.Logo }}
                  <img src="{{.Pigeon.Product.Logo | url }}" class="email-logo" />
                {{ else }}
                  {{ .Pigeon.Product.Name }}
                {{ end }}
                </a>
                        ...
                        <table class="body-sub">
                          <tbody>
                              {{ range $action := . }}
                                <tr>
                                  <td>
                                    <p class="sub">{{$.Pigeon.Product.TroubleText | replace "{ACTION}" $action.Button.Text}}</p>
